"""Unit tests for scripts/check_section_10_20_gate.py (bd-3po7)."""
...
SCRIPT = ROOT / "scripts" / "check_section_10_20_gate.py"

spec = importlib.util.spec_from_file_location("check_section_10_20_gate", SCRIPT)
...
class TestRunAllShape(unittest.TestCase):
    def test_run_all_shape(self) -> None:
        result = mod.run_all()
        self.assertEqual(result["bead_id"], "bd-3po7")
        self.assertEqual(result["section"], "10.20")
...
class TestCli(unittest.TestCase):
    ...
    def test_self_test_json_cli(self) -> None:
        ...
        self.assertEqual(parsed["bead_id"], "bd-3po7")
...
class TestConstants(unittest.TestCase):
    ...
    def test_domain_group_count(self) -> None:
        self.assertEqual(len(mod.DOMAIN_GROUPS), 15)
    ...
    def test_gate_bead_id(self) -> None:
        self.assertEqual(mod.GATE_BEAD, "bd-3po7")
