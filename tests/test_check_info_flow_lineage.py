"""Tests for scripts/check_info_flow_lineage.py (bd-2iyk)."""
...
SCRIPT = os.path.join(ROOT, "scripts", "check_info_flow_lineage.py")

spec = importlib.util.spec_from_file_location(
    "check_mod", os.path.join(ROOT, "scripts", "check_info_flow_lineage.py")
)
