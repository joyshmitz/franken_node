"""Unit tests for scripts/check_section_10_1_gate.py (bd-16sk)."""
...
SCRIPT = ROOT / "scripts" / "check_section_10_1_gate.py"

spec = importlib.util.spec_from_file_location("check_section_10_1_gate", SCRIPT)
...
class TestRunAllShape(unittest.TestCase):
    def test_run_all_shape(self) -> None:
        result = mod.run_all()
        self.assertEqual(result["bead_id"], "bd-16sk")
        self.assertEqual(result["section"], "10.1")
...
class TestCli(unittest.TestCase):
    ...
    def test_self_test_json_cli(self) -> None:
        ...
        self.assertEqual(parsed["bead_id"], "bd-16sk")
...
class TestConstants(unittest.TestCase):
    ...
    def test_gate_bead_id(self) -> None:
        self.assertEqual(mod.GATE_BEAD, "bd-16sk")
