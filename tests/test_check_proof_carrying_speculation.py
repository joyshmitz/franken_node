"""Unit tests for scripts/check_proof_carrying_speculation.py."""
...
SCRIPT = ROOT / "scripts/check_proof_carrying_speculation.py"

spec = importlib.util.spec_from_file_location("check_proof_carrying_speculation", SCRIPT)
...
class TestResultShape(unittest.TestCase):
    ...
    def test_bead_and_section(self):
        result = mod.run_all()
        self.assertEqual(result["bead_id"], "bd-1nl1")
...
class TestCli(unittest.TestCase):
    def test_json_output_parseable(self):
        ...
        self.assertEqual(parsed["bead_id"], "bd-1nl1")
