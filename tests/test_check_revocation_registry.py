...
from scripts import check_revocation_registry
...
class TestRevocationCli(unittest.TestCase):
    ...
    def test_json_mode_requests_full_proof_by_default(self):
        args = check_revocation_registry.parse_args(["--json"])

        self.assertTrue(check_revocation_registry.should_run_rust_tests(args))
